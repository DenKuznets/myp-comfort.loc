        ...
        <div class="header__content containers">
            ...
            <div class="header__nav">
                <ul class="nav nav__list-header">
                    ...
                    <li class="nav__item-header"><a href="#baths">Бани</a></li>
                    <li class="nav__item-header"><a href="#laundry">Прачечная</a></li>
                    <li class="nav__item-header"><a href="#info">Информация</a></li>
