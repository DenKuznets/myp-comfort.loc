    ...
    <div class="bath containers">
        <div class="bath__content">
            <div class="animate__animated bath__text">
                ...
                <h4>г. Арзамас, Короленко, 9</h4>
                <p>Русская парная, веники</p>
                <div class="bath__schedule">
                    <div class="bath__schedule-days">
                        <h4>График работы</h4>
                        <p class="bold">Пн-Вт: выходной</p>
                        <p class="bold">Ср: санитарный день</p>
                        <p class="bold">Чт, Сб: женский день</p>
                        <p class="bold">Пт, Вс: мужской день</p>
                    </div>
            ...
            <div class="animate__animated bath__image">
                @include('../components/swiperBath3')
            </div>
        </div>
    </div>
</section>
