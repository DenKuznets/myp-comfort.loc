<div id="room2PopUp" class="modalForm">
    <div class="modal-content-form rooms__popup">
        ...
        <h2>РУССКАЯ ПАРНАЯ + ОБЛИВНАЯ БОЧКА</h2>
        <table>
            <tr>
            ...
            <tr>
                <td>от 400 ₽ за человека/ 1 час*</td>
                <td>от 450 ₽ за человека/1 час*</td>
            </tr>
            
        </table>
        <p>* Стоимость зависит от продолжительности и количества человек. Более подробную информацию можно получить по телефону кассы (8 83147) 7 65 26 или здесь (ссылка на постановление)</p>
